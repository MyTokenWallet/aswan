...
def _get_stategy_largest_period(strategy_type):
    """
    Get the maximum duration of a policy of strategy_type type
    """
    # 1. When the data source and principal name are the same, scan the strategy data and get the maximum time period
    uuid_source_body = {}
    strategys = {}
    ...
    # 2. Scan threshold edits data and get the maximum time period
    threshold_edit_max = {}
