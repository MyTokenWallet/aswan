...
class RulesThresholdEdit(JSONResponseMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return self.render_json_response({'state': False, 'msg': _('Configuration read failed')})
        ...
        try:
            ...
            return self.render_json_response({'state': False, 'msg': _('Configuration write-back failed')})
